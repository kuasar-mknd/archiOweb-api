 ...
 */
router.post('/', verifyToken, parser.single('image'), validate(plantValidation), createPlant)
 ...
 *         description: Internal Server Error.
 */
router.put('/:id', verifyToken, parser.single('image'), validate([...plantIdValidation, ...plantValidation]), updatePlant)
